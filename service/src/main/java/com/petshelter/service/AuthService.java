 ...
 * [INTERFACES] [POLYMORPHISM] [METHOD OVERLOADING] [EXCEPTIONS]
 */
public class AuthService implements Authenticator {
    ...
    public void changePassword(User user, String oldPassword, String newPassword) throws ShelterException {
        ...
        if (newPassword == null || newPassword.length() < MIN_PASSWORD_LENGTH) {
            throw new ValidationException("password", "Password must be at least " + MIN_PASSWORD_LENGTH + " characters");
        }
